...
export function AuditTrailSection() {
  return (
    <section
      id="audit-trail"
      className="relative w-full pt-28 sm:pt-32 lg:pt-36 pb-24 lg:pb-32 overflow-hidden scroll-mt-28 sm:scroll-mt-32 lg:scroll-mt-36"
    >
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
            ShopPilot records the complete path from customer intent to checkout so merchants and users can understand exactly what the AI proposed, what policies allowed or rejected, and what happened during payment.
          </p>
        </div>
