...
interface DecisionReceiptProps {
  ...
  rejectedUpsell: { name: string; price: number };
    ...
    <div className="rounded-2xl bg-[#050816]/90 border border-blue-900/40 backdrop-blur-xl p-4 sm:p-5 space-y-3 font-mono text-xs shadow-xl">
      ...
      <div className="space-y-1.5 text-slate-300">
        ...
        <div className="flex justify-between py-1 border-b border-slate-900 text-rose-300">
          <span>Rejected Upsell:</span>
          <span className="line-through">{rejectedUpsell.name} (₹{rejectedUpsell.price})</span>
        </div>
